...
{/*       <mesh geometry={nodes['3D_Text_-_F'].geometry} material={materials['Floral Scent']} position={[-0.1, 0.05, 0]} rotation={[-Math.PI / 2, 0, 0]} scale={size} />
      ...
      <mesh geometry={nodes['3D_Text_-_C'].geometry} position={[0, 0, 0]} rotation={[-Math.PI / 2, 0, 0]} scale={size}>
        <meshStandardMaterial color={clr} />
      </mesh>
      <mesh geometry={nodes['3D_Text_-_o_1'].geometry} material={materials['Floral Scent']} position={[1.25, 0, 0]} rotation={[-Math.PI / 2, 0, 0]} scale={size} />
      <mesh geometry={nodes['3D_Text_-_d_1'].geometry} material={materials['Floral Scent']} position={[2.5, 0, 0]} rotation={[-Math.PI / 2, 0, 0]} scale={size} />
      <mesh geometry={nodes['3D_Text_-_e_2'].geometry} material={materials['Floral Scent']} position={[3.75, 0, 0]} rotation={[-Math.PI / 2, 0, 0]} scale={size} />
    </group>
  )
}
export default Text;
